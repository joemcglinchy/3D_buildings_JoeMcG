...
def extract_buildings_trees(pp_params):
    ...
    try:
        ...
        if buildingsfound:
            ...
            arcpy.AddGeometryAttributes_management(bdiso,
                                                   "AREA;PERIMETER_LENGTH", "METERS", "SQUARE_METERS", "")
            # Select
        ...
        if "TREES" in featureextraction.upper():
            ...
            if buildingsfound:
                ...
                arcpy.gp.FocalStatistics_sa(con_isnull_i1, focalst_isoc1, "Rectangle 3 3 CELL", "MAJORITY", "DATA")
                # Set Null
...
def create_lasd(las_path, lasd):
    try:
        ...
        if len(lasfiles) > 0:
            ...
            arcpy.CreateLasDataset_management(lasfiles, lasd, folder_recursion="NO_RECURSION",
