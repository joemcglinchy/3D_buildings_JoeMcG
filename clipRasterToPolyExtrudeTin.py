...
if ProductionMode:
    ...
    buildingFootprints = r'C:\Users\geof7015\PycharmProjects\testData\Boulder\Data.gdb\Buildings329'     # C:\Users\geof7015\PycharmProjects\testData\Charlotte\Data.gdb\BldgFootprints'
    ...
    outputWS = r'C:\Users\geof7015\PycharmProjects\testData\Boulder\Data.gdb'
    scratchGDB = arcpy.env.scratchGDB
    tempFolder = tempfile.mkdtemp()
...
with arcpy.da.SearchCursor(buildingFootprints, fields) as sc:
    for i, row in enumerate(sc):
        try:
            ...
            arcpy.sa.ZonalStatisticsAsTable(tp, "ID", dtmClipRastInt, minMaxElevTable, "true", "MIN_MAX_MEAN")
